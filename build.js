...
const SCRIPTS = ['vendor/phaser.min.js', 'js/config.js', 'js/save.js', 'js/classes.js', 'js/tower.js', 'js/weapon.js', 'js/textures.js', 'js/enemies.js', 'js/hud.js', 'js/shop.js', 'js/scene-select.js', 'js/scene-game.js', 'js/main.js'];
