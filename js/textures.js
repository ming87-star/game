...
function buildTextures(scene) {
  ...
  // 상징이 둘이면 상징이 아닙니다.
  //
  // 얼굴은 안 그립니다. 후드에 가려 어둡습니다 — 누구인지 특정하는 순간
  // 그건 어떤 사람의 이야기가 되고, 이 시퀀스는 그런 이야기가 아닙니다.
  //
  ...
  const 겉옷 = (key, 천, 안감) => {
    ...
    g.fillEllipse(18, 12, 10, 9);                // 후드 안 — 얼굴은 없습니다
    bake(key, 36, 46);
  };
  겉옷('cloak-red', 0xc62828, 0x8e1f1f);
  겉옷('cloak-white', 0xf5f5f5, 0xcfd8dc);
