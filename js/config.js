...
const CFG = {
  ...
  //
  // 가짜는 좋은 것인 척합니다. 다만 완전히 똑같게 두면 아이템을 집는 일이
  // 그냥 도박이 됩니다 — 알아볼 수 있는 표가 있어야 실력이 낄 자리가 생깁니다.
  // 진짜 아이템은 위아래로 크게 흔들리는데, 가짜는 조금만 느리게 흔들립니다.
  trap: {
    ...
    bobScale: 0.45,   // 가짜가 흔들리는 폭 (진짜 대비)
    bobSlower: 1.55,  // 가짜가 흔들리는 주기 (진짜 대비)
  },
