...
const CFG = {
  ...
  hasteStep: 0.12,   // 속 하나당 +12%. 여덟 개면 기본 한계에 닿습니다
  maxMult: 2,        // ×2는 겹치지 않습니다. 어차피 한 번에 한계까지 갑니다
  speedCapBase: 2.0, // 기본 한계 — 기본 속도의 두 배까지
  speedCapBonus: 0.6, // 메달 상점에서 한계를 이만큼 늘립니다
  ...
  slotChance: {
    ...
    haste: 0.075, // 약 14% — 공격 속도는 이제 이쪽이 기본이라 자주 나와야 합니다
