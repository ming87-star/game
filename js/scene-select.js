  ...
  buildDetail(job) {
    ...
    if (!open) {
      ...
      if (앞이열림) {
        ...
        //
        // **그래도 규칙은 적습니다.** 한동안 여기에 「한 판에서 700층 · 코인
        // 2000」만 적어 두었는데, 그러면 **아무 직업으로나 채우면 되는 것으로
        // 읽힙니다.** 실제로는 정해진 한 사람으로 올라야 열립니다. 새 저장에서
        // 잠긴 일곱 중 여섯이 이 줄을 봅니다 — 사슬을 넣고도 사슬을 안 적어
        // 둔 셈이었습니다.
        //
        // 이름은 감추고 **「그 사람으로」**만 붙입니다. 누구인지는 여전히
        // 궁금하고, 무엇을 해야 하는지는 이제 분명합니다.
        line('먼저 만나야 할 사람이 있습니다', 20, '#b0bec5', 4);
        line('그 사람으로  ' + 조건, 17, '#4a5578');
      }
      this.center(top);
