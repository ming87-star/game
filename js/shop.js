...
const SHOP_ITEMS = {
  ...
  // 「수호 부적」이었습니다. 무속의 물건이라 이 탑의 결과 안 맞기도 했지만,
  // 더 큰 문제는 **살아남은 공이 물건에게 간다**는 것이었습니다 — 값을 치르고
  // 산 물건이 내 죽음을 대신 받아 주는 그림입니다. 그러면 작더라도 「대신
  // 죽어 주는 것」이 하나 더 생깁니다.
  //
  // 지금 이름은 살아남은 까닭을 **나에게** 돌립니다. 내가 잘 안 죽는 사람이라서.
  // 열쇠(charm)는 그대로 둡니다 — 저장에 그 이름으로 들어가 있어서, 바꾸면
  // 이미 사 둔 사람의 것이 사라집니다.
  charm:   { title: '질긴 목숨',   desc: '쓰러질 때 한 번만 버팁니다' },
