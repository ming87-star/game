...
const CLASSES = [
  ...
  },
  {
    ...
    // 그건 초당 피해로 안 잡힙니다.
    // **곰이 막기까지 합니다.** 예전에는 앞서 가서 먼저 잡아 둘 뿐이라
    // 1.12 였는데, 이제 같은 층의 적이 주인공 대신 곰을 보고(chaseTarget)
    // 몸이 닿으면 곰이 대신 맞습니다. 그만큼이 주인공에게 안 갑니다 —
    // 실질 체력이 올라간 것이라 표에 안 잡히는 몫이 커졌습니다.
    표에안잡힘: '안 가 본 층을 먼저 치우고, 달려든 적을 대신 맞습니다',
    그럴듯: 1.25,
    name: '곰사냥꾼',
