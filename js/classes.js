...
const CLASSES = [
  {
    ...
    weapons: [
      ...
      // 멀리 가려면 걸음이 커야 합니다.
      { key: 'nameless', name: '무명검', dmg: 19, rate: 410, reach: 96, depth: 0,
...

  {
    ...
    weapons: [
      ...
      // 걸음으로 올리면 서른에서도 최강의 절반에 못 미칩니다. 늦게 시작해서
      // 멀리 가려면 걸음이 커야 합니다.
      { key: 'nameless', name: '무명궁', dmg: 17, rate: 330, range: 290, shots: 1, depth: 0,
        sheet: 0, color: 0x9e9e9e, plusMax: 30, plusStep: 0.54,
        detail: '맨몸은 약합니다. 대신 +1 을 서른까지 받습니다',
...

  {
    ...
    weapons: [
      ...
      // 걸음으로 올리면 서른에서도 최강의 절반에 못 미칩니다. 늦게 시작해서
      // 멀리 가려면 걸음이 커야 합니다.
      { key: 'nameless', name: '무명비수', dmg: 16, rate: 212, reach: 74, depth: 0,
        sheet: 0, color: 0x9e9e9e, plusMax: 30, plusStep: 0.54,
        detail: '맨몸은 약합니다. 대신 +1 을 서른까지 받습니다',
